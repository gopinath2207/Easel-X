"""
Django settings for EaselX project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-e!s(5@)5e2khwszuruh1c-h(_7ud2t=gx5rl#@-yl1@b9c18+8')

# SECURITY WARNING: don't run debug turned on in production!
# For local development / project review we enable DEBUG so Django will serve media files.
...
WSGI_APPLICATION = 'EaselX.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default='mysql://root:Umag@2207@localhost:3306/my_proj_db',
        conn_max_age=600
    )
}
...
STATIC_ROOT = BASE_DIR / "production_static"  # Directory where static files will be collected
